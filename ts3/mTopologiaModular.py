...
def teste():
  ...
  <diagram name="Page-1" id="c37626ed-c26b-45fb-9056-f9ebc6bb27b6">
    ...
    meio = f""""""
    meio = meio + switch("h46SICJPrgyOPjBbUtfY-1",0,200)
    meio = meio + switch("h46SICJPrgyOPjBbUtfY-2",200,200)
